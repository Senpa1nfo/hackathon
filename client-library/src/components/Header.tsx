    ...
    return (
        <header> 
            <Link to='/' className="logo">
                ...
                <div className="logo__text">History Of Ukraine</div>
            </Link>
                ...
                <nav className='navbar'>
                    <div className='navbar__wrapper'>
                        ...
                        <div className='navbar__list'>
                            ...
                            <Link onClick={toggleNavbar} to="/materials">Письмові матеріали</Link>
                        </div>
                    </div>
                    <div className='navbar__wrapper'>
                        ...
                        <div className='navbar__list'>
                            ...
                            <Link onClick={toggleNavbar} to="/forms-of-expression">Форми вираження</Link>
                        </div>
                    </div>
                </nav>
            </div>           
